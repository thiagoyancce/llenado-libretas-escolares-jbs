 ...
 * @author Admin
 */
public class FormConsolidados extends javax.swing.JFrame {
private Lista listaDirectory;
    ...
    /**
     * Creates new form FormConsolidados
     */
    public FormConsolidados() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jButtonChangeDirectoryOutput.setText("Seleccionar directorio salida");
        ...
        jButtonDeleteAll.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGap(29, 29, 29)
                                        .addComponent(jButtonChangeDirectoryOutput)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 61, Short.MAX_VALUE)
                                        .addComponent(jButtonProcess, javax.swing.GroupLayout.PREFERRED_SIZE, 93, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(64, 64, 64))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormConsolidados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
// jf.showOpenDialog(this);
    ...
    private void procesarArchivos() throws IOException {
      ...
      RegistroConsolidado registro=new RegistroConsolidado(Integer.parseInt(seleccionarBimestre( bimestre)));
      Consolidado consolidado=new Consolidado(rutaSalida.toString());
        for (int i = 0; i < listaDirectory.darTamaño(); i++) {
            ...
            consolidado.procesarDatos(notas,datosBAG);
            // consolidado.exito();
        }
        jTextAreaEstado.append("\n Finalizado ");
    }
